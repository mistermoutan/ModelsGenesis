...
if __name__ == "__main__":
    ...
    config = setup_config(input_rows=64,
                        input_cols=64,
                        input_deps=32,
                        crop_rows=64,
                        crop_cols=64,
    ...
    np.save("tr_cubes" + "_"+str(config.input_rows)+"x"+str(config.input_cols)+"x"+str(config.input_deps)+".npy",
        slice_set_tr_array)
    np.save("tr_cubes" + "_"+str(config.input_rows)+"x"+str(config.input_cols)+"x"+str(config.input_deps)+"_target.npy",
        slice_set_tr_target_array)
    np.save("val_cubes" + "_"+str(config.input_rows)+"x"+str(config.input_cols)+"x"+str(config.input_deps)+".npy",
        slice_set_val_array)
    np.save("val_cubes" + "_"+str(config.input_rows)+"x"+str(config.input_cols)+"x"+str(config.input_deps)+"_target.npy",
        slice_set_val_target_array)
    np.save("ts_cubes" + "_"+str(config.input_rows)+"x"+str(config.input_cols)+"x"+str(config.input_deps)+".npy",
        slice_set_ts_array)
    np.save("ts_cubes" + "_"+str(config.input_rows)+"x"+str(config.input_cols)+"x"+str(config.input_deps)+"_target.npy",
