# FROM : https://github.com/junqiangchen/LUNA16-Lung-Nodule-Analysis-2016-Challenge/blob/master/LUNA16Challege/dataprocess/LUNA_mask_extraction.py
...
def make_mask(mask, v_center, v_diam,spacing):
    #why the + 1, rounding up! it's not part of denominator
...
for subsetindex in range(10):
    ...
    for fcount, img_file in enumerate(file_list_path):
        ...
        mask_itk = np.clip(mask_itk, 0, 1).astype('uint8')
